...
RSpec.describe FbPageDecorator do
  ...
  it "should return fb cover images" do
 ...
 {"width"=>2860,
  ...
  it "should return default cover images" do
  ...
  it "should return fb page name" do
    expect(fb_page.decorate.name).to eq('Grasruts')
  end

  it "should return fb page address" do
  ...
  it "should return photos of the fb page" do
